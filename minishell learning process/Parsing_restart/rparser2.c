...
// implemented dollar presence function.
// there was something wrong how it was working when i use pointers to loop through the cmd->token string.
// the d_flag was in info but i had to move it in to the t_new structure.